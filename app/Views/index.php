...
<!-- Mirrored from templates.g5plus.net/glowing/home-02.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 23 Feb 2023 11:42:07 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>vendors/slick/slick.min.css">
    <link rel="stylesheet" href="<?= base_url() ?>vendors/magnific-popup/magnific-popup.min.css">
    <link rel="stylesheet" href="<?= base_url() ?>vendors/jquery-ui/jquery-ui.min.css">
    <link rel="stylesheet" href="<?= base_url() ?>vendors/animate.css">
    <link rel="stylesheet" href="<?= base_url() ?>vendors/mapbox-gl/mapbox-gl.min.css">
    <link rel="stylesheet" href="<?= base_url() ?>vendors/fonts/font-phosphor/css/phosphor.min.css">
    <link rel="stylesheet" href="<?= base_url() ?>vendors/fonts/tuesday-night/stylesheet.min.css">
    <link rel="stylesheet" href="<?= base_url() ?>vendors/fonts/butler/stylesheet.min.css">
    <link rel="stylesheet" href="<?= base_url() ?>vendors/fonts/a-antara-distance/stylesheet.min.css">

    <link rel="stylesheet" href="<?= base_url() ?>css/themes.css">

    <link rel="icon" href="<?= base_url() ?>images/logo/favicon.png">
    ...
    <meta name="twitter:image" content="<?= base_url() ?>images/logo_01.png">
    ...
    <meta property="og:image" content="<?= base_url() ?>images/logo_01.png">
...
<body>
                    ...
                    <div class="d-none d-xl-block">
                        <div class="d-flex align-items-center flex-nowrap">
                            <div class="w-50 d-flex align-items-center">
                                <a href="#search-popup" data-gtf-mfp="true" data-mfp-options='{"type":"inline","focus": "#keyword","mainClass": "mfp-search-form mfp-move-from-top mfp-align-top"}' class="nav-search d-flex align-items-center pr-3 mr-auto">
                            ...
                            <div class="mx-auto flex-shrink-0 position-static">
                                <div class="d-flex mt-3 mt-xl-0 align-items-center w-100 justify-content-center">
                                    <a class="navbar-brand mx-4 mx-xxl-10 d-none d-xl-inline-block" href="/home">
                            ...
                            <div class="w-50 d-flex align-items-center justify-content-between">
                                <ul class="navbar-nav hover-menu main-menu px-0 mx-xl-n5">
                                    <li aria-haspopup="true" aria-expanded="false" class="nav-item  py-2 py-xl-7 sticky-py-xl-6 px-0 px-xl-5">
                                        <a class="nav-link p-0" href="" data-toggle="dropdown">
                                            Blog
                                            <span class="caret"></span>
                                        </a>
                                    ...
                                    <li aria-haspopup="true" aria-expanded="false" class="nav-item  py-2 py-xl-7 sticky-py-xl-6 px-0 px-xl-5">
                                        <a class="nav-lin kp-0" href="" data-toggle="dropdown">
                                            Docs
                                            <span class="caret"></span>
                                        </a>
                                ...
                                <ul class="navbar-nav flex-row justify-content-xl-end d-flex flex-wrap text-body py-0 navbar-right">
                                                        ...
                                                        <ul class="p-0">
                                                            ...
                                                            <li class="dropdown-item px-0">
                                                                <a class="dropdown-link" href="/logout">
                                                                    <i class="fa fa-sign-out mr-2"></i> <span> Logout</span>
                                                                </a>
                                                            </li>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link position-relative px-4 py-0" href="">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link position-relative px-4 menu-cart py-0 d-inline-flex align-items-center mr-n2" href="#" data-canvas="true" data-canvas-options='{"container":".cart-canvas"}'>
                                            ...
                                            <span class="position-absolute number" id="totalcart">0</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
    ...
    <main id="content">
        <section class="mx-0 slick-slider dots-inner-center custom-slider-02 slider" data-slick-options='{"slidesToShow": 1,"infinite":true,"autoplay":true,"dots":true,"arrows":false,"fade":true,"cssEase":"ease-in-out","speed":600}'>
            <!-- Banner  -->
            <?php
            if (count($bannerModel) > 0) {
                foreach ($bannerModel as $bannerModel) {
            ?>
                    <div class="box px-0">
                        <div class="slider-responsive bg-img-cover-center py-12 py-lg-17" style="background-image: url('<?= $bannerModel['image'] ?>');">
                            <div class="container container-xl pt-7 pb-9">
                                <div data-animate="fadeInDown">
                                    <p class="text-white mb-5 font-weight-600 fs-24 lh-15"><?= $bannerModel['header'] ?></p>
                                    <h1 class="text-white font-weight-500 mb-10 fs-48 fs-md-68 lh-128"><?= $bannerModel['title'] ?> <br>
                                    </h1>
                                </div>
                                <a href="" class="btn btn-link btn-light bg-transparent text-white border-bottom border-0 rounded-0 p-0 fs-16 font-weight-600 border-2x" data-animate="fadeInUp">
                                    Discover Now
        ...
        <section class="my-lg-13 my-10">
            <div class="container container-xl">
                <h2 data-animate="fadeInUp mb-8">Shop By Category</h2>
            </div>
                    ...
                    ?>
                            <div class="box">
                                <div class="card border-0 hover-shine hover-zoom-in banner banner-03">
                                    <div class="card-img bg-img-cover-center" style="background-image: url('<?= $categories['category_img']; ?>');"></div>
                                    <div class="card-img-overlay d-inline-flex flex-column px-7 pt-7 pb-6 justify-content-end">
                                        <h3 class="card-title center-text-color fs-26"><?= $categories['category_name']; ?></h3>
                                        <div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    ?>
                            <div class="col-lg-3 col-md-6">
                                <div class="card border-0 mb-lg-0 mb-6" data-animate="fadeInUp">
                                    <a href="" class="hover-zoom-in hover-shine"><img width="200" height="200" src="<?= $featured['f_image'] ?>" alt="Bodycare"></a>
                                    <div class="card-body text-center">
                                        <h4 class="card-title mb-1"><a href=""><?= $featured['f_name'] ?></a></h4>
                                    </div>
                                </div>
                            </div>
                    <?php
        ...
        <section data-animated-id="7" style="border: 1px solid#edf1f0;">
            <div class="row mx-0">
                ...
                <div class="col-lg-6 d-flex align-items-center justify-content-center py-lg-0 py-md-17 py-13">
                    <img src="<?= base_url() ?>images/banner/banner-02.png" alt="">
                </div>
            </div>
        </section>
                            ...
                            <div class="tab-pane fade " id="pills-Bodycare" role="tabpanel" aria-labelledby="pills-Bodycare-tab">
                                <div class="row">
                                    <div class="col-lg-3 col-sm-6 mb-5" data-animate="fadeInUp">
                                        <div class="card border-0 product">
                                            <div class="position-relative">
                                                <img src="<?= base_url() ?>images/product-03.jpg" alt="Coffee Bean Caffeine Eye Cream">
                                                <div class="card-img-overlay d-flex p-3">
                                                    <div>
                                                    </div>
                                                    <div class="my-auto w-100 content-change-vertical">
                                            ...
                                            <div class="card-body px-0 pt-4 text-center">
                                                ...
                                                <h2 class="card-title fs-15 font-weight-500 mb-2"><a href="">Hollis
                                    ...
                                    <div class="col-lg-3 col-sm-6 mb-5" data-animate="fadeInUp">
                                        <div class="card border-0 product">
                                            <div class="position-relative">
                                                <img src="<?= base_url() ?>images/product-04.jpg" alt="Bio-shroom Rejuvenating Serum">
                                                <div class="card-img-overlay d-flex p-3">
                                                    <div>
                                                    </div>
                                                    <div class="my-auto w-100 content-change-vertical">
                                            ...
                                            <div class="card-body px-0 pt-4 text-center">
                                                ...
                                                <h2 class="card-title fs-15 font-weight-500 mb-2"><a href="">Bio-shroom
                                    ...
                                    <div class="col-lg-3 col-sm-6 mb-5" data-animate="fadeInUp">
                                        <div class="card border-0 product">
                                            <div class="position-relative">
                                                <img src="<?= base_url() ?>images/product-05.jpg" alt="Coffee Bean Caffeine Eye Cream">
                                                <div class="card-img-overlay d-flex p-3">
                                                    <div>
                                                    </div>
                                                    <div class="my-auto w-100 content-change-vertical">
                                            ...
                                            <div class="card-body px-0 pt-4 text-center">
                                                ...
                                                <h2 class="card-title fs-15 font-weight-500 mb-2"><a href="">Glinting
    ...
    <script src="<?= base_url() ?>vendors/bootstrap/bootstrap.bundle.js"></script>
    <script src="<?= base_url() ?>vendors/bootstrap-select/js/bootstrap-select.min.js"></script>
    <script src="<?= base_url() ?>vendors/slick/slick.min.js"></script>
    <script src="<?= base_url() ?>vendors/waypoints/jquery.waypoints.min.js"></script>
    <script src="<?= base_url() ?>vendors/counter/countUp.js"></script>
    <script src="<?= base_url() ?>vendors/magnific-popup/jquery.magnific-popup.min.js"></script>
    <script src="<?= base_url() ?>vendors/hc-sticky/hc-sticky.min.js"></script>
    <script src="<?= base_url() ?>vendors/jparallax/TweenMax.min.js"></script>
    <script src="<?= base_url() ?>vendors/mapbox-gl/mapbox-gl.js"></script>
    <script src="<?= base_url() ?>vendors/isotope/isotope.js"></script>
    ...
    <div class="modal sign-in" id="sign-in" tabindex="1" role="dialog" aria-hidden="false">
                        ...
                        <div class="col-md-6 pr-xl-5 mb-8 mb-md-0 pl-xl-8">
                            <div class="galleries-product product galleries-product-02 position-relative">
                                ...
                                <div class="view-slider-for mx-0">
                                    ...
                                    <div class="box px-0">
                                        <div class="card p-0 rounded-0 border-0">
                                            <a href="<?= base_url() ?>images/product/product-02.jpg" class="card-img">
                                    ...
                                    <div class="box px-0">
                                        <div class="card p-0 rounded-0 border-0">
                                            <a href="<?= base_url() ?>images/product/product-03.jpg" class="card-img">
                                                <img src="<?= base_url() ?>images/product/product-03.jpg" alt="product gallery">
                                            </a>
                                        </div>
                                    </div>
                                    <div class="box px-0">
                                        <div class="card p-0 rounded-0 border-0">
                                            <a href="<?= base_url() ?>images/product/product-04.jpg" class="card-img">
